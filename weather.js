...
document.addEventListener('DOMContentLoaded', function () {
    ...
    themeToggleBtn.addEventListener('click', function () {
        ...
        if (isDarkTheme) {
            ...
            bg.src = "./bg.jpg"
            document.querySelector(".mobile").style.border = "1px solid rgba(255, 255, 255, 0.176)"
            body.style.backgroundColor = "#030408"
            ...
            // darkbox.forEach( (e) => {
                ...
                body.style.backgroundColor = "#145567"
            bg.src = "./bg2.jpg"
            document.querySelector(".mobile").style.border = "1px solid rgba(255, 255, 255, 0.295)"
